...
if (!function_exists('hogwords_trx_addons_get_css')) {
	add_filter('hogwords_filter_get_css', 'hogwords_trx_addons_get_css', 10, 4);
	function hogwords_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.widget_contacts .contacts_info .contacts_address_title, .widget_contacts .contacts_info .contacts_email_title, .widget_contacts .contacts_info .contacts_phone_title{
	color: {$colors['text_dark']};
}
...
header .sc_blogger_default .sc_blogger_item .sc_blogger_item_title a{
	color: {$colors['inverse_text']};
}
header .sc_blogger_default .sc_blogger_item .sc_blogger_item_title a:hover{
	color: {$colors['text_dark']};
}
header .sc_blogger_default .sc_blogger_item .post_featured .mask{
...
.sc_title .sc_title_for_icon:before{
	border-color: {$colors['text_link']};
}
...
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(even) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['text_link2']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(odd) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['text_hover']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(1) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['input_bd_hover']};
	color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(2) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['text_link2']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(3) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['text_hover']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(4) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['text_hover']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(5) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['text_link']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(6) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['input_bd_hover']};color: {$colors['inverse_text']};
}



.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(even) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['text_link2']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(odd) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['text_hover']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(1) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['input_bd_hover']};
	color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(2) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['text_link2']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(3) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['text_hover']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(4) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['text_hover']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(5) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['text_link']};color: {$colors['inverse_text']};
}
.sc_courses.sc_courses_default .sc_courses_columns_wrap > [class*="trx_addons_column-"]:nth-child(6) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['input_bd_hover']};color: {$colors['inverse_text']};
}
...
.sc_courses.sc_courses_default .sc_courses_item_meta, .sc_courses.sc_courses_default .sc_courses_item_date{
	color: {$colors['text_light']};
}
...
.courses_single .courses_page_buttons a.sc_button.theme_button{
	color: {$colors['inverse_text']}!important;
	background-color: {$colors['text_hover']}!important;
}
.courses_single .courses_page_buttons a.sc_button.theme_button:hover{
	color: {$colors['inverse_text']}!important;
	background-color: {$colors['text_link2']}!important;
}
.related_wrap.courses_page_related.sc_courses.sc_courses_default .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(1) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['text_hover']};color: {$colors['inverse_text']};
}
.related_wrap.courses_page_related.sc_courses.sc_courses_default .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(2) .sc_courses_item .sc_courses_item_title{
	background-color: {$colors['text_link2']};color: {$colors['inverse_text']};
}

.related_wrap.courses_page_related.sc_courses.sc_courses_default .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(1) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['text_hover']};color: {$colors['inverse_text']};
}
.related_wrap.courses_page_related.sc_courses.sc_courses_default .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(2) .sc_courses_item .trx_addons_hover_mask{
	background-color: {$colors['text_link2']};color: {$colors['inverse_text']};
}
...
.sc_price_item:hover .sc_price_item_title, .scheme_default .sc_price_item:hover .sc_price_item_title a, .sc_price_item:hover .sc_price_item_icon{
	color: {$colors['extra_dark']};
}
.sc_price.sc_price_default .sc_price_columns_wrap > [class*="trx_addons_column-"]:nth-child(even) .sc_price_item .sc_price_item_inner .sc_price_item_info .sc_price_item_link.sc_button{
	background-color: {$colors['bg_color']};
	color: {$colors['text_link']};
}
.sc_price.sc_price_default .sc_price_columns_wrap > [class*="trx_addons_column-"]:nth-child(odd) .sc_price_item .sc_price_item_inner .sc_price_item_info .sc_price_item_link.sc_button{
	background-color: {$colors['bg_color']};
	color: {$colors['text_link2']};
}
.sc_price.sc_price_default .sc_price_columns_wrap > [class*="trx_addons_column-"]:first-child .sc_price_item .sc_price_item_inner .sc_price_item_info .sc_price_item_link.sc_button{
	background-color: {$colors['bg_color']};
	color: {$colors['text_hover']};
}

.sc_price.sc_price_default .sc_price_columns_wrap > [class*="trx_addons_column-"]:nth-child(even) .sc_price_item .sc_price_item_inner .sc_price_item_info .sc_price_item_link.sc_button:hover{
	background-color: {$colors['input_bd_hover']};
	color: {$colors['extra_dark']};
}
.sc_price.sc_price_default .sc_price_columns_wrap > [class*="trx_addons_column-"]:nth-child(odd) .sc_price_item .sc_price_item_inner .sc_price_item_info .sc_price_item_link.sc_button:hover{
	background-color: {$colors['text_hover2']};
	color: {$colors['extra_dark']};
}
.sc_price.sc_price_default .sc_price_columns_wrap > [class*="trx_addons_column-"]:first-child .sc_price_item .sc_price_item_inner .sc_price_item_info .sc_price_item_link.sc_button:hover{
	background-color: {$colors['text_link2']};
	color: {$colors['extra_dark']};
}
...
.ubermenu.ubermenu-main > .ubermenu-nav > li > .ubermenu-target:hover{color: {$colors['extra_text']};	}
.ubermenu.ubermenu-main > .ubermenu-nav > li.ubermenu-active > .ubermenu-target{
	color: {$colors['extra_text']};	
}
...
.ubermenu-main .ubermenu-submenu.ubermenu-submenu-drop li a:hover, .ubermenu-main .ubermenu-submenu.ubermenu-submenu-drop li a:hover:after{
	color: {$colors['inverse_link']};	
}
.ubermenu .ubermenu-tab-layout-left>.ubermenu-tabs-group{
	border-color: {$colors['inverse_link']};	
}
.ubermenu.ubermenu-main>.ubermenu-nav > li.ubermenu-current-menu-ancestor > .ubermenu-target, 
.ubermenu.ubermenu-main>.ubermenu-nav > li.ubermenu-current-menu-item > .ubermenu-target{
	background-color: {$colors['text_link2']};
	color: {$colors['extra_text']};	
}

.ubermenu.ubermenu-main .ubermenu-nav li.ubermenu-current-menu-ancestor  li.ubermenu-current-menu-item .ubermenu-target, 
.ubermenu.ubermenu-main .ubermenu-nav li.ubermenu-current-menu-ancestor  li.ubermenu-current-menu-item .ubermenu-target:after, 
.ubermenu.ubermenu-main .ubermenu-nav li.ubermenu-current-menu-ancestor  li.ubermenu-current-menu-parent > .ubermenu-target, 
.ubermenu.ubermenu-main .ubermenu-nav li.ubermenu-current-menu-ancestor  li.ubermenu-current-menu-ancestor  > .ubermenu-target{
	color: {$colors['inverse_link']};	
}
...
.ubermenu .ubermenu-retractor:hover, .ubermenu .ubermenu-retractor:hover i{
	color: {$colors['text_hover']};
}
