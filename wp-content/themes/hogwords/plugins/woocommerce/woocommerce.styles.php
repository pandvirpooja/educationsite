...
if ( !function_exists( 'hogwords_woocommerce_get_css' ) ) {
	add_filter( 'hogwords_filter_get_css', 'hogwords_woocommerce_get_css', 10, 4 );
	function hogwords_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.woocommerce.widget_shopping_cart .quantity, .woocommerce .widget_shopping_cart .quantity, .woocommerce-page.widget_shopping_cart .quantity, .woocommerce-page .widget_shopping_cart .quantity, .single-product div.product .woocommerce-tabs .wc-tabs li a, .woocommerce table.cart td.actions .button{
	{$fonts['button_font-family']}
}
...
.woocommerce .list_products.shop_mode_thumbs ul.products li.product > .post_item.post_layout_thumbs{
	border-color: {$colors['bd_color']};
}
.woocommerce .list_products.shop_mode_thumbs ul.products li.product > .post_item.post_layout_thumbs:hover{
	border-color: {$colors['text_link']};
}
.woocommerce ul.products li.product .post_featured.hover_shop_buttons .icons a{
	background-color: {$colors['extra_bg_color']};
}
.woocommerce ul.products li.product .post_featured.hover_shop_buttons .icons a.shop_link{
 	background-color: {$colors['text_hover']};
}
.woocommerce ul.products li.product .post_featured.hover_shop_buttons .icons a:hover{
	background-color: {$colors['text_hover']};
	color: {$colors['inverse_text']};
}
.woocommerce ul.products li.product .post_featured.hover_shop_buttons .icons a.shop_link:hover{
 	background-color: {$colors['extra_bg_color']};
 	color: {$colors['inverse_text']};
}
#btn-buy,
...
.woocommerce-page div.product form.cart .single_add_to_cart_button.button:hover{
...
.woocommerce div.product div.summary a.add_to_wishlist:hover{
	background-color: {$colors['text_link2']};
 	color: {$colors['extra_text']};
}
...
.single-product ul.products li.product .post_item:hover{
	border-color: {$colors['text_link']};
}
...
/* Shop mode selector */
.hogwords_shop_mode_buttons a {
	color: {$colors['text']};
}
.hogwords_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
.shop_mode_thumbs .hogwords_shop_mode_buttons a.woocommerce_thumbs,
