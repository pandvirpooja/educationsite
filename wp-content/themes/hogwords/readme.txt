== Hogwords ==
Version: 1.2.6
Copyright: 2017, AxiomThemes
WordPress version: required at least 4.5, tested up to 6.3.1
...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Hogwords'.
Please install and activate it before starting to use the theme Hogwords.
...
Theme documentation is available on https://hogwords.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Hogwords is Fontello.
