...
if (!function_exists('hogwords_customizer_get_css')) {

	function hogwords_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = hogwords_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('hogwords_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(hogwords_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = hogwords_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = hogwords_customizer_add_theme_colors($colors);
...
li a, .sidebar .sidebar_inner h5 a, figure figcaption a,
...
table tr:first-child th, table tr:first-child th + th, table tr:first-child td + th  {
...
input[placeholder]::-webkit-input-placeholder{ color: {$colors['input_light']}; }
textarea[placeholder]::-webkit-input-placeholder	{ color: {$colors['input_light']}; }
input[placeholder]::-moz-placeholder{ color: {$colors['input_light']}; }
textarea[placeholder]::-moz-placeholder				{ color: {$colors['input_light']}; }
input[placeholder]:-ms-input-placeholder{ color: {$colors['input_light']}; }
textarea[placeholder]:-ms-input-placeholder			{ color: {$colors['input_light']}; }
input[placeholder]::placeholder{ color: {$colors['input_light']}; }
textarea[placeholder]::placeholder					{ color: {$colors['input_light']}; }

input[placeholder]:focus::-webkit-input-placeholder{ color: {$colors['input_dark']}; }
input[placeholder]:focus::-moz-placeholder{ color: {$colors['input_dark']}; }
input[placeholder]:focus:-ms-input-placeholder{ color: {$colors['input_dark']}; }
input[placeholder]:focus::placeholder{ color: {$colors['input_dark']}; }
...
.tribe-common .tribe-events-header__events-bar button:before,
...
.sc_layouts_row_type_narrow .sc_layouts_item_details_line1 a,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item_details_line1 a {
	color: {$colors['extra_text']};
}
...
.sc_layouts_row_type_narrow .sc_layouts_item_details_line2 a,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item_details_line2 a {
	color: {$colors['extra_link']};
}
.sc_layouts_row_type_narrow .sc_layouts_login_details .sc_layouts_item_details_line2,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_login_details .sc_layouts_item_details_line2 {
	color: {$colors['extra_dark']};
}
.sc_layouts_row_type_narrow .sc_layouts_item a.trx_addons_login_link {
	color: {$colors['text_menu']};
}
.sc_layouts_row_type_narrow .sc_layouts_item a.trx_addons_login_link:hover {
	color: {$colors['text_link']}!important;
}
.sc_layouts_row_type_compact .sc_layouts_item a.trx_addons_login_link {
	color: {$colors['extra_dark']};
}
.sc_layouts_row_type_narrow .sc_layouts_item .sc_layouts_cart:hover .sc_layouts_cart_icon {
	color: {$colors['text_link']}!important;
}
...
.sc_layouts_row_type_narrow .sc_layouts_menu_nav > li > a.trx_addons_popup_link:hover,
.sc_layouts_row_type_narrow .sc_layouts_menu_nav > li > a.trx_addons_login_link:hover,
.sc_layouts_row_type_narrow .sc_layouts_menu_nav > li.sfHover > a.trx_addons_login_link{
		color: {$colors['text_link']}!important;
	}
...
.sc_layouts_row_type_compact .sc_layouts_item_details_line1 a,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item_details_line1 a {
	color: {$colors['extra_text']};
}

.sc_layouts_row_type_compact .sc_layouts_item_details_line2 a,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item_details_line2 a {
	color: {$colors['inverse_link']};
}
...
.sc_layouts_menu_nav > li > a.trx_addons_popup_link:hover,
.sc_layouts_menu_nav > li > a.trx_addons_login_link:hover,
.sc_layouts_menu_nav > li.sfHover > a.trx_addons_login_link{
...
.sc_layouts_row_type_narrow .sc_layouts_item a.trx_addons_login_link .sc_layouts_item_details_line1:hover,
.sc_layouts_row_type_narrow .sc_layouts_item a.trx_addons_login_link .sc_layouts_item_details_line2:hover{
	color: {$colors['text_dark']} !important;
}
.sc_layouts_title_caption{
	color: {$colors['text_menu']};
}
.sc_layouts_featured.with_content.with_image .sc_layouts_title_caption{
	color: {$colors['inverse_text']};
}

/* Menu */
.sc_layouts_menu_nav > li > a, .sc_layouts_menu_uber  li > a {
	color: {$colors['text_dark']};
}
...
.sc_layouts_menu_nav > li.current-menu-ancestor > a,
 .sc_layouts_menu_uber > li.current-menu-item > a,
.sc_layouts_menu_uber > li.current-menu-parent > a,
.sc_layouts_menu_uber > li.current-menu-ancestor > a{
	color: {$colors['text_dark']} !important;
	background-color: {$colors['text_link2']};
}
.sc_layouts_menu_nav .menu-collapse > a:before,
.sc_layouts_menu_uber .menu-collapse > a:before{
	color: {$colors['alter_text']};
}
.sc_layouts_menu_nav .menu-collapse > a:after,
.sc_layouts_menu_uber .menu-collapse > a:after{
	background-color: {$colors['alter_bg_color']};
}
.sc_layouts_menu_nav .menu-collapse > a:hover:before,
.sc_layouts_menu_uber .menu-collapse > a:hover:before{
	color: {$colors['alter_link']};
}
.sc_layouts_menu_nav .menu-collapse > a:hover:after,
.sc_layouts_menu_uber .menu-collapse > a:hover:after{
	background-color: {$colors['alter_bg_hover']};
}
...
.sc_layouts_menu_nav > li li li > a:hover,
.sc_layouts_menu_nav > li li li.sfHover > a {
	color: {$colors['extra_text']} !important;
	background-color: {$colors['text_link']} !important;
}
.sc_layouts_menu_nav > li li li > a:hover:after {
	color: {$colors['extra_text']} !important;
}
.sc_layouts_menu_nav > li li li li > a:hover,
.sc_layouts_menu_nav > li li li li.sfHover > a {
	color: {$colors['extra_text']} !important;
	background-color: {$colors['text_link2']} !important;
}
.sc_layouts_menu_nav > li li li li > a:hover:after {
	color: {$colors['extra_text']} !important;
}
...
.scheme_self.top_panel_default .top_panel_navi.sc_layouts_row_fixed_on {
	background-color: {$colors['text_link']};
}
...
.hogwords_tabs .hogwords_tabs_titles li a:hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.hogwords_tabs .hogwords_tabs_titles li.ui-state-active a {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link']};
}
...
.post_meta_item.post_counters_item, .post_counters_item:before, .post_meta_item.post_share .socials_share .socials_caption_label, .socials_share .socials_caption:before{
	color: {$colors['extra_dark']};
}
.post_meta_item.post_share .socials_share:hover .socials_caption_label, .socials_share:hover .socials_caption:before{
	color: {$colors['text_link']};
}
.post_date a, a.post_author{
	color: {$colors['text_link']};
}
.post_date a:hover,
...
.post_meta_item.post_counters_item.post_counters_likes{
	background-color: {$colors['text_link2']};
}
...
.mejs-embed,
.mejs-embed body, .trx_addons_audio_player.with_cover .mejs-controls {
	background: {$colors['input_bd_hover']}!important;
}
...
.post_item_single .post_header .post_meta_item a, .post_item_single .post_header a.post_meta_item{
	color: {$colors['text_link']};
}
.post_item_single .post_meta_item > a:hover,
.post_item_single .post_meta_item .socials_caption:hover,
.post_item_single .post_edit a:hover,
 .post_item_single .post_header a.post_meta_item:hover{
	color: {$colors['text_dark']};
}
...
.sidebar .sidebar_inner h5 a:hover,
.sidebar .sidebar_inner a{
	color: {$colors['text_link']};
}
.wp-block-calendar a:hover,
.sidebar .sidebar_inner a:hover{
	color: {$colors['text_dark']};
}
.sidebar .sidebar_inner .widget_recent_posts .post_title a{
	color: {$colors['text_dark']};
}
.sidebar .sidebar_inner .widget_recent_posts .post_title a:hover{
	color: {$colors['text_link']};
}
...
.footer_wrap.footer_default .wp-calendar-nav a::before,
.footer_wrap.footer_default .widget_calendar td#prev a:before{
	background-color: {$colors['alter_bg_color']};
}
...
.scheme_self.footer_wrap .widget_nav_menu li a:hover,
.footer_wrap .scheme_self.vc_row .widget_nav_menu li a:hover {
	color: {$colors['inverse_dark']};
}
.footer_wrap .widget.widget_nav_menu li:after{
...
CSS;
					...
					$rez = apply_filters('hogwords_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'hogwords_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>