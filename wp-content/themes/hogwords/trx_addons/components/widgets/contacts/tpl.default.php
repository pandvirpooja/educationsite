	...
	if (!empty($address) || !empty($phone) || !empty($email)) {
		?><div class="contacts_info"><?php
			if (!empty($address)) {
				...
				?><span class="contacts_address_title"><?php esc_html_e('Address:', 'hogwords') ?></span>
			...
			if (!empty($phone) || !empty($email)) {
				...
				if (!empty($email)) {
					?><span class="contacts_email_title"><?php esc_html_e('Email:', 'hogwords') ?></span>
					<span class="contacts_email"><a href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email); ?></a></span><?php
				}
				if (!empty($phone)) {
					?><span class="contacts_phone_title"><?php esc_html_e('Phone:', 'hogwords') ?></span>
